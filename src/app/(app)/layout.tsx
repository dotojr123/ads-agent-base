    ...
    <div className="flex h-screen bg-[#0a0a0a] text-white overflow-hidden">
      ...
      <aside className="w-64 border-r border-gray-800 bg-gray-900 flex flex-col">
        ...
        <nav className="flex-1 p-4 space-y-1 overflow-y-auto">
          ...
          <Link href="/app/automations" className="flex items-center gap-3 px-3 py-2 text-gray-300 hover:text-white hover:bg-gray-800 rounded-lg transition">
             <span>⚡</span> Automações
          </Link>
          <Link href="/app/alerts" className="flex items-center gap-3 px-3 py-2 text-gray-300 hover:text-white hover:bg-gray-800 rounded-lg transition">
             <span>🔔</span> Alertas
          </Link>
